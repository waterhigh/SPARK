...
from clip.best_model_MAE import CLIP
import gc
import time
...
MODEL_PATH = "./weight_sa/best_hdbm51_b8_CLS_FILIP_MAE_MASK75.pth"
...
def train_and_validate(model, train_loader, val_loader):
    ...
    for epoch in range(TOTAL_EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            print(f"Saved Best Model ({best_val_loss:.4f}) at {MODEL_PATH}")
        else:
